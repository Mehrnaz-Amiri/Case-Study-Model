...
con <- DBI::dbConnect(odbc::odbc(), Driver = "Snowflake", Server = "fp.snowflakecomputing.com", UID = userName, PWD = Password, Database = "ELV_NEURELIS", Warehouse = "test_artemis_shift_wh", Schema = "nrl_vco_hcp")

con2 <- DBI::dbConnect(odbc::odbc(), Driver = "Snowflake", Server = "fp.snowflakecomputing.com", UID = userName, PWD = Password, Database = "ELV_NEURELIS", Warehouse = "test_artemis_shift_wh", Schema = "nrl_vco_hcp")

con_model <- DBI::dbConnect(odbc::odbc(), Driver = "Snowflake", Server = "fp.snowflakecomputing.com", UID = userName, PWD = Password, Database = "ELV_NEURELIS", Warehouse = "test_artemis_shift_wh", Schema = "NRL_VCO_HCP_MODELS")
```
...
act2_b$VENDOR <- ifelse(act2_b$VENDOR == "Valtoco", "", act2_b$VENDOR)
...
```{r}
cases_valtoco <- rbind(case1, case1.1, case1.2, case1.3, case2, case3, case3.1, case3.2, case4, case5, case5.1, case5.2, case6, case6.1, case7, case8, case9)
names(cases_valtoco) <- toupper(names(cases_valtoco))
cases_valtoco[,c(6:40)][is.na(cases_valtoco[,c(6:40)])] <- ""
#cases[,c(5)][is.nan(cases[,c(5)])] <- 0
cases_valtoco
```

```{r}
write.csv(cases_valtoco, '~/Desktop/CaseStudy_Valtoco_10-12-23.csv', row.names = FALSE)
```
